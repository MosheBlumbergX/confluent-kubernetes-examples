...
#. Deploy OpenLdap
   ...
   ::
     ...
     --set-file tls.fullchain=$TUTORIAL_HOME/../../assets/certs/generated/server.pem \
     --set-file tls.privkey=$TUTORIAL_HOME/../../assets/certs/generated/server-key.pem \
     --set-file tls.cacerts=$TUTORIAL_HOME/../../assets/certs/generated/ca.pem \
     --namespace confluent
